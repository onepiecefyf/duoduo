...
<title>${query} - 商品搜索 - 大冯商场</title>
<meta name="Keywords" content="java,大冯商场java" />
<meta name="description" content="在大冯商场中找到了29910件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
...
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	...
	<a href="search.html?q=${query}&page=${page}">${page}</a>
...
<li class="item-book" bookid="11078102">
	...
	<div class="service">由 大冯商场 发货</div>
	<div class="extra">
