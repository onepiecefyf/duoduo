...
<body class="easyui-layout">
    <div data-options="region:'west',title:'菜单',split:true" style="width:180px;">
    	<ul id="menu" class="easyui-tree" style="margin-top: 10px;margin-left: 5px;">
         	...
         	<li>
       			<span>规格参数管理</span>
       			<ul>
       				<li data-options="attributes:{'url':'itemCat-param-list'}">分类规格参数</li>
       				<li data-options="attributes:{'url':'item-param-list'}">商品规格参数</li>
       			</ul>
       		</li>
         	<li>
         		<span>网站内容管理</span>
    ...
    <div data-options="region:'center',title:''">
    	<div id="tabs" class="easyui-tabs">
		    <div title="首页" style="padding:0px;margin: 30px 70px;">
		        <img alt="淘淘" src="imag/index.png">
